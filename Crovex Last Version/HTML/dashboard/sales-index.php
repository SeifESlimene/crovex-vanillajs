...
<!--
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="../product/ecommerce-products.php"><i class="ti-control-record"></i>Product</a></li>
                        <li class="nav-item"><a class="nav-link" href="../product/ecommerce-product-list.php"><i class="ti-control-record"></i>Product List</a></li>
                        <li class="nav-item"><a class="nav-link" href="../product/ecommerce-product-detail.php"><i class="ti-control-record"></i>Product Detail</a></li>
                        <li class="nav-item"><a class="nav-link" href="../product/ecommerce-cart.php"><i class="ti-control-record"></i>Cart</a></li>
                        <li class="nav-item"><a class="nav-link" href="../product/ecommerce-checkout.php"><i class="ti-control-record"></i>Checkout</a></li>
                    </ul>
                </li>
            -->
                <li>
                        ...
                        <div class="col-lg-4">
                            <div class="card">                                
                                <div class="card-body text-right pb-0">
                                    <button type="button" class="btn btn-sm btn-gradient-primary float-right" onclick="update()">Update<i class="dripicons-clockwise ml-2"></i></button>
                                </div> <!--end card-body-->                            
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="media">
                                                <img src="../assets/images/logo-sm.png" height="40" class="mr-4 align-self-center" alt="...">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="balence-nav">
                                        <ul class="nav nav-pills justify-content-center text-center mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="pills-credit-card-tab" data-toggle="pill" href="#pills-credit-card">
                                                    <img src="../assets/images/cards/card-1.png" alt=""  class="img-fluid">
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="pills-paypal-tab" data-toggle="pill" href="#pills-paypal">
                                                    <img src="../assets/images/cards/card-2.png" alt=""  class="img-fluid">
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="pills-bitcoin-tab" data-toggle="pill" href="#pills-bitcoin">
                                                    <img src="../assets/images/cards/card-3.png" alt=""  class="img-fluid">
                                                </a>
                                            </li>
                                        </ul>
