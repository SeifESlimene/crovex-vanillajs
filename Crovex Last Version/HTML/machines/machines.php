        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                  <input type="text" name="needles" class="form-control" placeholder="Needles">
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                  <input type="text" name="belt" class="form-control" placeholder="Belt(mm)">
                  </div>
                </div>
                
                <div class="col-md-6">
                  <div class="form-group">
                  <input type="text" name="machine_nb" class="form-control" placeholder="Machine Number">
                  </div>
                </div>
              </div>
                    ...
                    <div class="row">
                        ...
                        <p class="text-muted mb-2">
                            ...
                            <span class="float-left">
                                ...
                                <!--
                                <h4 class="page-title">Machines List</h4>
                                -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Machines List</h4>
